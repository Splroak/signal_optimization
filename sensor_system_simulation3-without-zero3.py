...
class Sensor:
    ...
    def calculate_send_rate(self):
        ...
        print('just wanna print stuff', len(self.send_status), success_time)
...
if __name__ == '__main__':
    ...
    num_iteration = 500  # when one sensor is reach this iteration, random send data will stop.
    ...
    simulate_send_receive_data(simulation_system, simulation_sensors, num_iteration, m_sensor_transmission_interval)
